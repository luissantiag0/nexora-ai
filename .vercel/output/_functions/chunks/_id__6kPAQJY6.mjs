...
import { b as actualizarEstadoLead, f as anadirNotaLead, o as obtenerLeads, h as obtenerAccionSiguiente, E as ESTADOS_LEAD } from './leadStorage_C3jvhflq.mjs';
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (Astro2.request.method === "POST") {
    ...
    if (intent === "convert-to-invoice") {
      const { createInvoiceFromLead } = await import('./invoices_weJHw2DQ.mjs');

...
const getCurrentPremiumUser = async (token) => {
...
export { getCurrentAdmin, getCurrentPremiumUser, getCurrentUser, getTrialRemainingMs, loginAdmin, loginUser, logoutAdmin, logoutUser, registerUser, userHasPremiumAccess, userIsAdmin };
